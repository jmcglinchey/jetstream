export const MOCK_API_DESCRIBE_ACCOUNT = {
  data: {
    actionOverrides: [],
    activateable: false,
    ...
    childRelationships: [
      ...
      {
        cascadeDelete: true,
        childSObject: 'AccountForecast',
        deprecatedAndHidden: false,
        field: 'AccountId',
        junctionIdListNames: [],
        junctionReferenceTo: [],
        relationshipName: 'AccountForecasts',
        restrictedDelete: false,
      },
      {
        cascadeDelete: true,
      ...
      {
        cascadeDelete: true,
        childSObject: 'AccountTeamMember',
        deprecatedAndHidden: false,
        field: 'AccountId',
        junctionIdListNames: [],
        junctionReferenceTo: [],
        relationshipName: 'AccountTeamMembers',
        restrictedDelete: false,
      },
      {
        cascadeDelete: true,
      ...
      {
        cascadeDelete: true,
        childSObject: 'AdvAccountForecastFact',
        deprecatedAndHidden: false,
        field: 'AccountId',
        junctionIdListNames: [],
        junctionReferenceTo: [],
        relationshipName: 'AdvAcctForecastFacts',
        restrictedDelete: false,
      },
      {
        cascadeDelete: true,
        childSObject: 'AdvAcctForecastSetPartner',
        deprecatedAndHidden: false,
        field: 'AccountId',
        junctionIdListNames: [],
        junctionReferenceTo: [],
        relationshipName: 'AdvAcctForecastSetPartners',
        restrictedDelete: false,
      },
      {
        cascadeDelete: true,
      ...
      },
      {
        ...
        junctionIdListNames: [],
        junctionReferenceTo: [],
        relationshipName: 'PersonCampaignMembers',
        restrictedDelete: false,
      },
      {
        cascadeDelete: false,
      ...
      },
      {
        ...
        junctionIdListNames: [],
        junctionReferenceTo: [],
        relationshipName: 'PersonCreditMemos',
        restrictedDelete: false,
      },
      {
        cascadeDelete: false,
      ...
      },
      {
        ...
        junctionIdListNames: [],
        junctionReferenceTo: [],
        relationshipName: 'PersonEntitlementContacts',
        restrictedDelete: false,
      },
      {
        cascadeDelete: true,
      ...
      },
      {
        ...
        junctionIdListNames: [],
        junctionReferenceTo: [],
        relationshipName: 'PersonInvoices',
        restrictedDelete: false,
      },
      {
        cascadeDelete: false,
      ...
      {
        cascadeDelete: false,
        childSObject: 'ProductFulfillmentLocation',
        deprecatedAndHidden: false,
        field: 'AccountId',
        junctionIdListNames: [],
        junctionReferenceTo: [],
      ...
      {
        cascadeDelete: false,
        childSObject: 'SOSSession',
        deprecatedAndHidden: false,
        field: 'ContactId',
        junctionIdListNames: [],
        junctionReferenceTo: [],
        relationshipName: 'PersonSOSSessions',
        restrictedDelete: false,
      },
      {
        cascadeDelete: true,
      ...
      },
      {
        ...
        junctionIdListNames: [],
        junctionReferenceTo: [],
        relationshipName: 'PersonServiceContracts',
        restrictedDelete: true,
      },
      {
        cascadeDelete: false,
    ...
    fields: [
      ...
      },
      {
        ...
        mask: null,
        maskType: null,
        name: 'PersonOtherGeocodeAccuracy',
        nameField: false,
        namePointing: false,
        nillable: true,
        permissionable: true,
      ...
      },
      {
        ...
        byteLength: 3900,
        calculated: true,
        calculatedFormula: 'Name & " - " & AccountNumber & "\\n" & "new line"',
        cascadeDelete: false,
        caseSensitive: false,
        compoundFieldName: null,
        controllerName: null,
      ...
      },
      {
        ...
        idLookup: false,
        inlineHelpText: null,
        label: 'Is Fancy Account',
        length: 0,
        mask: null,
        maskType: null,
        name: 'Is_Fancy_Account__c',
        nameField: false,
        namePointing: false,
        nillable: false,
        permissionable: true,
      ...
      },
      {
        ...
        byteLength: 0,
        calculated: true,
        calculatedFormula: '$Permission.My_Custom_Perm',
        cascadeDelete: false,
        caseSensitive: false,
        compoundFieldName: null,
        controllerName: null,
        ...
        htmlFormatted: false,
        idLookup: false,
        inlineHelpText: 'Has custom permission',
        label: 'Has Permission',
        length: 0,
        mask: null,
        maskType: null,
        name: 'Has_Permission__c',
        nameField: false,
        namePointing: false,
        nillable: false,
        permissionable: true,
      ...
      },
      {
        ...
        idLookup: false,
        inlineHelpText: null,
        label: 'Is Fancy Person',
        length: 0,
        mask: null,
        maskType: null,
        name: 'Is_Fancy_Person__pc',
        nameField: false,
        namePointing: false,
        nillable: false,
        permissionable: true,
    ...
    recordTypeInfos: [
      {
        ...
        master: false,
        name: 'Company',
        recordTypeId: '012Dn000000AHkYIAW',
        urls: {
          layout: '/services/data/v56.0/sobjects/Account/describe/layouts/012Dn000000AHkYIAW',
        },
      },
      {
        active: true,
        ...
        master: false,
        name: 'Fancy',
        recordTypeId: '012Dn000000AvCtIAK',
        urls: {
          layout: '/services/data/v56.0/sobjects/Account/describe/layouts/012Dn000000AvCtIAK',
        },
      },
      {
        active: true,
        ...
        master: false,
        name: 'Person',
        recordTypeId: '012Dn000000AHkdIAG',
        urls: {
          layout: '/services/data/v56.0/sobjects/Account/describe/layouts/012Dn000000AHkdIAG',
        },
      },
      {
        active: true,
        ...
        master: false,
        name: 'Person Account',
        recordTypeId: '012Dn000000AHkiIAG',
        urls: {
          layout: '/services/data/v56.0/sobjects/Account/describe/layouts/012Dn000000AHkiIAG',
        },
      },
      {
        active: true,
        ...
        urls: {
          layout: '/services/data/v56.0/sobjects/Account/describe/layouts/012000000000000AAA',
        },
      },
    ],
    replicateable: true,
    ...
    supportedScopes: [
      {
        label: "My account team's accounts",
        name: 'account_team',
      },
      {
        label: "My team's account team and their accounts",
        name: 'accountteam_team',
      },
      {
        label: 'All accounts',
        name: 'everything',
      ...
      {
        label: 'My account team and my accounts',
        name: 'own_accountteam',
      },
      {
    ...
    updateable: true,
    urls: {
      compactLayouts: '/services/data/v56.0/sobjects/Account/describe/compactLayouts',
      rowTemplate: '/services/data/v56.0/sobjects/Account/{ID}',
      approvalLayouts: '/services/data/v56.0/sobjects/Account/describe/approvalLayouts',
      uiDetailTemplate: 'https://jetstream-test-1-dev-ed.develop.my.salesforce.com/{ID}',
      uiEditTemplate: 'https://jetstream-test-1-dev-ed.develop.my.salesforce.com/{ID}/e',
      listviews: '/services/data/v56.0/sobjects/Account/listviews',
      describe: '/services/data/v56.0/sobjects/Account/describe',
      uiNewRecord: 'https://jetstream-test-1-dev-ed.develop.my.salesforce.com/001/e',
      quickActions: '/services/data/v56.0/sobjects/Account/quickActions',
      layouts: '/services/data/v56.0/sobjects/Account/describe/layouts',
      sobject: '/services/data/v56.0/sobjects/Account',
    },
  },
};
